            ...
            <div class='col-m-12'>
                ...
                <div class="col-md-4">
                    <div class="card cart-summery">
                        ...
                        <div class="card-body">
                            <div class="sub-title">
                                <h2 class="bg-white">Giỏ hàng</h3>
                            </div>
                            <div class="d-flex justify-content-between pb-2">
                                <div>Tổng tiền</div>
                                <div>{{ number_format(Cart::subtotal(),3)}}</div>
                            </div>

                            <div class="pt-2">
                                <a href="{{route('front.checkout')}}" class="btn-dark btn btn-block w-100">Tiếp tục thanh toán</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body d-flex justify-content-center align-items-center ">
                            <h4>Đơn hàng của bạn đang trống!</h4>
                        </div>
                    </div>
