...
<body data-instant-intensity="mousedown">
            ...
            <div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
                <div class="col-lg-4 logo">
                    <a href="{{route("front.home")}}" class="text-decoration-none">
                        <span class="h1 text-uppercase text-primary bg-dark px-2">Bình An</span>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="footer-card">
                        <h3>Liên hệ</h3>
                        <p>
                            236B Lê Văn Sĩ, phường 1, Quận Tân Bình, TPHCM <br>
                            nganbui@example.com <br>
                            0374822130</p>
                    </div>
                </div>
    ...
    <script src="{{ asset('front-assets/js/jquery-3.6.0.min.js')}}">
    </script>
