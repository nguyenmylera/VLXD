                        ...
                        <div class="d-flex align-items-center justify-content-end mb-4">
                            <div class="ml-2">
                                ...
                                <select name="sort" id="sort" class="from-control">
                                    <option value="latest" {{ ($sort == 'latest') ? 'selected': ''}}>Gần đây</option>
                                    <option value="price_desc" {{ ($sort == 'price_desc') ? 'selected': ''}}>Giá cao</option>
                                    <option value="price_asc" {{ ($sort == 'price_asc') ? 'selected': ''}}>Giá thấp</option>
                                </select>
                            </div>
                        </div>
                    </div>
