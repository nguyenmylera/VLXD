...
<section class="content-header">
    <div class="container-fluid my-2">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Danh mục phụ</h1>
            </div>
            <div class="col-sm-6 text-right">
                <a href="{{ route('sub-categories.create') }}" class="btn btn-primary">Thêm mới</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @else
                        <tr>
                            <td colspan="5">Không tìm thấy dữ liệu</td>
                        </tr>
                        @endif
...
<script>
    function deleteSubCategory(id) {
        ...
        if (confirm("Bạn chắc chắn muốn xoá")) {
