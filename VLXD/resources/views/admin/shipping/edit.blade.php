    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{ route('shipping.create') }}" class="btn btn-primary">Trở về</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select name="country" id="country" class="form-control">
                                    ...
                                    @endforeach
                                    <option {{ ( $shippingCharge->country_id == 'rest_of_world') ? 'selected' : ''}} value="rest_of_world">Thành phố/Tỉnh khác</option>
                                    @endif
                                </select>
